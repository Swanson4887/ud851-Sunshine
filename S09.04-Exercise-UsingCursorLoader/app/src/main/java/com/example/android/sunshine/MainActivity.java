...
public class MainActivity extends AppCompatActivity implements
    ...
    public static final String[] MAIN_FORECAST_DESIRED = {
    WeatherContract.WeatherEntry.COLUMN_DATE,
    WeatherContract.WeatherEntry.COLUMN_MAX_TEMP,
    WeatherContract.WeatherEntry.COLUMN_MIN_TEMP,WeatherContract.WeatherEntry.COLUMN_WEATHER_ID};
    public static final int COLUMN_D_INDEX = 0;
    public static final int COLUMN_M_TEMP = 1;
    public static final int COLUMN_ = 2;
    public static final int COLUMN_W_ID = 3;
...
//          COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
    ...
    public void onLoadFinished(Loader<Cursor> cursor, Cursor data) {
        mForecastAdapter.Cursorswap(data);
    ...
    public void onLoaderReset(Loader<Cursor> cursor) {
        mForecastAdapter.Cursorswap(null);
